        ...
        <div className="w-full md:w-1/2 text-left mb-12 md:mb-0">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
            ...
            <div className="typing-container">
              <span className="typing-text text-gradient font-extrabold">
                Indrajeeth
              </span>
            </div>
          </h1>
          ...
          >
            I specialize in creating elegant solutions for complex problems.
            From responsive web apps to robust backend systems.
          </p>
